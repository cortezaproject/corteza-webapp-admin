<template>
  <b-form-group :label="`${title}: ${value.handle}`">
    ...
    <b-form-group :label="$t('auth-settings.external-providers.handle')" horizontal>
      <b-input-group>
        <b-form-input v-model="value.handle" :formatter="alphanum" />
      </b-input-group>
    </b-form-group>
    <b-form-group :label="$t('auth-settings.external-providers.issuer')" horizontal>
      <b-input-group>
        <b-form-input v-model="value.issuer" />
      </b-input-group>
    </b-form-group>
    <b-form-group :label="$t('auth-settings.external-providers.key')" horizontal>
      <b-input-group>
