...
Refer to the [Administrator Guide](https://docs.cortezaproject.org/corteza-docs/2021.9/administrator-guide/index.html) for details on how to use the web application.
